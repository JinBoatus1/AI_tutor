      ...
      <div className="signin-modal" onClick={(e) => e.stopPropagation()}>
        ...
        {view === "main" && (
          <div className="signin-providers">
            ...
            <button className="signin-provider-btn signin-provider--microsoft" onClick={() => handleProvider("microsoft")} disabled={busy}>
              <MicrosoftIcon /> Continue with Microsoft
            </button>
            <button className="signin-provider-btn signin-provider--apple" onClick={() => handleProvider("apple")} disabled={busy}>
