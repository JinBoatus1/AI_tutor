    ...
    <div className="home-page">
      ...
      <section className="home-hero" aria-labelledby="home-headline">
        ...
        <div className="home-primary-block">
          ...
          {!loading && !user && (
            <button type="button" className="home-btn home-btn--google" onClick={login}>
              <GoogleIcon size={18} />
              Sign in with Google
            </button>
          )}
        ...
        {!loading && !user && (
          <p className="home-microcopy">
            You can open Learning Mode without an account. Google sign-in only adds saved chats and synced progress.
          </p>
        )}
